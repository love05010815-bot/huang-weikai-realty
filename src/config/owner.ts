...
export const OWNER = {
  ...
  /** 純門牌（頁尾用，不帶括號裡的店名） */
  addressStreet: "台中市梧棲區四維中路338號",
  /** 公司／品牌名 */
  company: "太平洋房屋",
  /**
   * 經紀業揭露 —— 2026-09-08 系統擁有者指定放在首頁與 /map 的頁尾最底部。
   * 加盟店的法人是「馥勵不動產經紀有限公司」，不是太平洋房屋；經紀人與證號照他給的字。
   * 591 版型（post591-template.ts）另有一份手打的同一行，那份是固定版型，不要改成讀這裡。
   */
