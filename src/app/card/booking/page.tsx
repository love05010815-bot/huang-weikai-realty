...
export const metadata: Metadata = {
  ...
  description: `線上預約${OWNER.name}房產諮詢。買賣房產、資產配置、稅務諮詢、簡易裝潢，選好時段直接預約，系統會寄確認信給你。服務台中海線沙鹿、梧棲、清水、龍井。`,
  ...
  openGraph: {
    ...
    description: `買賣房產、資產配置、稅務諮詢、簡易裝潢，線上選時段直接預約${OWNER.name}。`,
    url: "/card/booking",
  ...
  twitter: {
    ...
    title: `線上預約諮詢｜台中海線房仲${OWNER.name}`,
    description: `買賣房產、資產配置、稅務諮詢、簡易裝潢，線上選時段直接預約。`,
    images: ["/profile.jpg"],
  },
};
