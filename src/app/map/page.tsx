 ...
 *    2026-09-05 起**沒有 0 案的區了**。這條規則本身留著 —— 之後再加新區，
 *    在它還是 0 案的時候**一樣不准寫進標題或 keywords** —— 那等於
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // ⚠️ 只加真的有建案的區。2026-09-05 起八個區都有案子了。
    "台中海線建案",
    "沙鹿建案",
    "沙鹿車站商圈",
    "沙鹿新成屋",
    ...
    "新光田特區",
    "沙鹿新光田",
    // 2026-09-05 補：梧棲市區 166 案、清水市區 1 案進來之後才加的。
    // ⚠️ 標題不加 —— 「市區」是行政區的下一層，照上面「行政區的下一層不進標題」那條；
    //    而且標題已經有「梧棲・清水」，市區的案子搜「梧棲建案」本來就找得到。
    "梧棲市區建案",
    "清水市區建案",
    OWNER.name,
  ],
  ...
  openGraph: {
    ...
    /* 跟首頁同一張 1200×630 的分享預覽圖（直式照會被平台橫裁掉頭，見首頁 metadata 的註解） */
