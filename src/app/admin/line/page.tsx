 ...
 *   2. 「我接手」—— 按下去機器人就對那個客戶閉嘴
 *   3. 2026-08-21 起：**直接在這裡回客戶**，不用切到 LINE App
 *
 * ⚠️ 後台回覆走 push API，每一則都吃官方帳號的免費訊息額度（reply 是免費的，
 *    但 replyToken 約 1 分鐘就過期，你看到訊息時早就沒了）。所以燈號多一顆「本月訊息額度」。
 *
 * 前三顆燈號是機器人自動回覆的體檢報告，三顆全綠它才會真的回話。
 * 第四顆跟機器人開不開無關 —— 它管的是「你本人在後台還能回幾則」。
 */
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              {m.content}
                              {m.media ? (
                                <LineMedia kind={m.media.kind} url={m.media.url} maxHeight={300} />
                              ) : null}
                            </div>
